    ...
    <xsl:template match="/">
        ...
        <body>
            <p>
                ...
                <xsl:if test="$param2 = 'notify'"><strong>sent to the Approver for review</strong>.  If you are the Emergency Management Captain, please review the report and fill in any remaining details before submitting to the Administrator.</xsl:if>
            ...
            <p>
                Please click <a href="{concat('https://was8-intra-dev.toronto.ca/webapps/movie_app/#/', $param1)}">this link</a> to review the Fire Review Report.
            </p>
        </body>
        </html>
    </xsl:template>
